...
O HDFS foi projetado para executar MapReduce \textit{jobs}, que por sua vez, realizam leitura, processamento e escrita de arquivos extremamente grandes \cite{venner2009}. Apesar de apresentar semelhanças com os sistemas de arquivos distribuídos existentes seu grande diferencial está na alta capacidade de tolerância a falhas, no baixo custo de hardware que é requerido e também na escalabilidade linear.
...
\begin{center}
  \begin{tabular}{|p{3cm}|p{2cm}|p{3cm}|p{4cm}|}
	...
	\\ \hline
  \end{tabular}
  \caption{Configurações das máquinas Yahoo, extraída de 
...
O HDFS foi construído a partir deste modelo proposto por \citeonline{ghemawatGfs2003}. Todas as características abordadas nas sessões anteriores, referentes ao HDFS, foram definidas com base neste trabalho. O HDFS apresenta uma alternativa \textit{open-source} implementada em Java para o GFS.
...
\begin{figure}[ht!]
	...
	\caption{Arquitetura MapReduce, retirado de \cite{ghemawatMapreduce2008}}
